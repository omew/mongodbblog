...
<?php foreach ($posts as $post): ?>
    <article class="post">
        ...
        <div class="post-head">
            <h1 class="post-title"><?= Html::a($post->title, ['post', 'id' => $post->id]) ?></h1>
            <div class="post-meta">
                ...
                <span><i class="fa fa-clock-o"></i>
                    <time class="date"
                          datetime="<?= Yii::$app->formatter->asDate($post->created) ?>"><?= Yii::$app->formatter->asDate($post->created) ?></time>
                </span> &bull;
                <span>
        ...
        <div class="post-permalink">
            <?= Html::a('阅读原文', ['post', 'id' => $post->id], ['class' => 'btn btn-default']) ?>
        </div>
