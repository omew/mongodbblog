...
class CategoryTree extends yii\base\Object
{
    ...
    public function __construct()
    {
        ...
        foreach ($allCategories as $v) {
            $this->_allCategories[$v['id']] = $v;//将id作为key
            if (!array_key_exists($v['id'], $this->_childCategoryIds)) {
                $this->_childCategoryIds[$v['id']] = [];
            }
            $this->_childCategoryIds[$v['parent']][] = $v['id'];
            $this->_parentCategoryIds[$v['id']] = $v['parent'];
        }
    }
